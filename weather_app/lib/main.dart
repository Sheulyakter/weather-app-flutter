...
class _WeatherAppState extends State<WeatherApp> {
  ...
  void fetchSearch ( String input) async {
    try {
      ...
      setState(() {
        errorMessage = "Sorry, we dont have data about this city. Try another one.";
      });
    }
  }
          ...
          body: Column(
            ...
            children: <Widget> [
                Column(
                  children: [
                    Center(
                      child: Image.network('https://www.metaweather.com/static/img/weather/png/'+abbrevation+'.png',
                        width: 100,
                      ),
                    ),
                    Center(
